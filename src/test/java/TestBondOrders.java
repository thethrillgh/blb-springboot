...
public class TestBondOrders {
    ...
    public void testOrderTimeStamp() {
        ...
        BondOrder bondOrder = new BondOrder(ldt, tradeDate, settlementDate, 100.0, 5.0, 105.0,2, tbond, tuser);
    ...
    public void testTransactionAmt() {
        ...
        assertEquals(100.0, bondOrder.getprincipal(), 0.00);

        assertNotEquals(200.0, bondOrder.getprincipal(), 0.00);

        bondOrder.setprincipal(200.0);

        assertNotEquals(100.0, bondOrder.getprincipal(), 0.00);

        assertEquals(200.0, bondOrder.getprincipal(), 0.00);
    }
